...
from app.core.db import execute_read_query, test_connection
...
def build_summary_markdown(result: DiscoveryResult) -> str:
    ...
    lines.append(
        "_Auto-generated by `python -m app.discovery.schema_discovery`. "
...
def main(argv: list[str] | None = None) -> int:
    ...
    print("Next: run `python -m app.discovery.data_dictionary` to build the data dictionary.")
    return 0
